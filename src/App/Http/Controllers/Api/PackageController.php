...
class PackageController extends Controller
{
    ...
    public function index(Request $request, packageManage $packageManage)
    {
        ...
        $table = resolve('builderTable')
                                    ...
                                    ->rightButton(['buttonType'=>'add',     'apiUrl'=> route('api.admin.app.package.add'),'title'=>'安装', 'show'=> ['uninstall']])                       // 添加删除按钮
                                    ->rightButton(['buttonType'=>'forbid',  'apiUrl'=> route('api.admin.app.package.status'), 'show'=>['open']])    //禁用
                                    ->rightButton(['buttonType'=>'resume',  'apiUrl'=> route('api.admin.app.package.status'), 'show'=>['off']])                                     //启动
                                    ->rightButton(['buttonType'=>'delete',  'apiUrl'=> route('api.admin.app.package.delete'),'title'=>'卸载', 'hide'=>['uninstall']])                       // 添加删除按钮
